        ...
        if (EXTERNAL_MMX(mm_flags)) {
            ...
            if (EXTERNAL_MMXEXT(mm_flags)) {
                ...
                if (EXTERNAL_SSSE3(mm_flags)) {
                    ...
                    PEL_LINK_SSE(c->put_hevc_qpel, 5, 1, 1, qpel_hv8,  8);
                    PEL_LINK_SSE(c->put_hevc_qpel, 6, 1, 1, qpel_hv8,  8);
                    PEL_LINK_SSE(c->put_hevc_qpel, 7, 1, 1, qpel_hv4,  8);
                    PEL_LINK_SSE(c->put_hevc_qpel, 8, 1, 1, qpel_hv4,  8);
                    PEL_LINK_SSE(c->put_hevc_qpel, 9, 1, 1, qpel_hv8,  8);
                ...
                if (EXTERNAL_SSE4(mm_flags)) {
                    ...
                    PEL_LINK(c->put_hevc_epel, 2, 0, 0, pel_pixels6 , 8);
                    ...
                    PEL_LINK(c->put_hevc_epel, 2, 0, 1, epel_h6,  8);
                  ...
                  //  PEL_LINK(c->put_hevc_epel,32, 0, 1, epel_h32, 8);

                    PEL_LINK(c->put_hevc_epel, 0, 1, 0, epel_v2,  8);
                    PEL_LINK(c->put_hevc_epel, 1, 1, 0, epel_v4,  8);
                    PEL_LINK(c->put_hevc_epel, 2, 1, 0, epel_v6,  8);
                  ...
                  //  PEL_LINK(c->put_hevc_epel,32, 1, 0, epel_v32, 8);

                    PEL_LINK(c->put_hevc_epel, 0, 1, 1, epel_hv2, 8);
                    PEL_LINK(c->put_hevc_epel, 1, 1, 1, epel_hv4, 8);
                    PEL_LINK(c->put_hevc_epel, 2, 1, 1, epel_hv2, 8);
                    PEL_LINK(c->put_hevc_epel, 3, 1, 1, epel_hv8, 8);
                    PEL_LINK(c->put_hevc_epel, 4, 1, 1, epel_hv4, 8);
                    PEL_LINK(c->put_hevc_epel, 5, 1, 1, epel_hv8, 8);
                    PEL_LINK(c->put_hevc_epel, 6, 1, 1, epel_hv8, 8);
                    PEL_LINK(c->put_hevc_epel, 7, 1, 1, epel_hv8, 8);
                    PEL_LINK(c->put_hevc_epel, 8, 1, 1, epel_hv8, 8);
        ...
        if (EXTERNAL_MMX(mm_flags)) {
            if (EXTERNAL_MMXEXT(mm_flags)) {
                ...
                if (EXTERNAL_SSE4(mm_flags)) {
                    ...
                    PEL_LINK(c->put_hevc_epel, 2, 0, 0, pel_pixels2 ,10);
                    PEL_LINK(c->put_hevc_epel, 3, 0, 0, pel_pixels8 ,10);
                    PEL_LINK(c->put_hevc_epel, 4, 0, 0, pel_pixels4 ,10);
                    PEL_LINK(c->put_hevc_epel, 5, 0, 0, pel_pixels8 ,10);
                    PEL_LINK(c->put_hevc_epel, 6, 0, 0, pel_pixels8 ,10);
                    PEL_LINK(c->put_hevc_epel, 7, 0, 0, pel_pixels8 ,10);
                    PEL_LINK(c->put_hevc_epel, 8, 0, 0, pel_pixels8 ,10);
                    PEL_LINK(c->put_hevc_epel, 9, 0, 0, pel_pixels8 ,10);
                    PEL_LINK(c->put_hevc_epel, 0, 0, 1, epel_h2,  10);
                    PEL_LINK(c->put_hevc_epel, 1, 0, 1, epel_h4,  10);
                    PEL_LINK(c->put_hevc_epel, 2, 0, 1, epel_h2,  10);
                    PEL_LINK(c->put_hevc_epel, 3, 0, 1, epel_h8,  10);
                    PEL_LINK(c->put_hevc_epel, 4, 0, 1, epel_h4,  10);
                    PEL_LINK(c->put_hevc_epel, 5, 0, 1, epel_h8,  10);
                    PEL_LINK(c->put_hevc_epel, 6, 0, 1, epel_h8,  10);
                    PEL_LINK(c->put_hevc_epel, 7, 0, 1, epel_h8,  10);
                    PEL_LINK(c->put_hevc_epel, 8, 0, 1, epel_h8,  10);
                    PEL_LINK(c->put_hevc_epel, 9, 0, 1, epel_h8,  10);
                    PEL_LINK(c->put_hevc_epel, 0, 1, 0, epel_v2,  10);
                    PEL_LINK(c->put_hevc_epel, 1, 1, 0, epel_v4,  10);
                    PEL_LINK(c->put_hevc_epel, 2, 1, 0, epel_v2,  10);
                    PEL_LINK(c->put_hevc_epel, 3, 1, 0, epel_v8,  10);
                    PEL_LINK(c->put_hevc_epel, 4, 1, 0, epel_v4,  10);
                    PEL_LINK(c->put_hevc_epel, 5, 1, 0, epel_v8,  10);
                    PEL_LINK(c->put_hevc_epel, 6, 1, 0, epel_v8,  10);
                    PEL_LINK(c->put_hevc_epel, 7, 1, 0, epel_v8,  10);
                    PEL_LINK(c->put_hevc_epel, 8, 1, 0, epel_v8,  10);
                    PEL_LINK(c->put_hevc_epel, 9, 1, 0, epel_v8,  10);
                    PEL_LINK(c->put_hevc_epel, 0, 1, 1, epel_hv2, 10);
                    PEL_LINK(c->put_hevc_epel, 1, 1, 1, epel_hv4, 10);
                    PEL_LINK(c->put_hevc_epel, 2, 1, 1, epel_hv2, 10);
                    PEL_LINK(c->put_hevc_epel, 3, 1, 1, epel_hv8, 10);
                    PEL_LINK(c->put_hevc_epel, 4, 1, 1, epel_hv4, 10);
                    PEL_LINK(c->put_hevc_epel, 5, 1, 1, epel_hv8, 10);
                    PEL_LINK(c->put_hevc_epel, 6, 1, 1, epel_hv8, 10);
                    PEL_LINK(c->put_hevc_epel, 7, 1, 1, epel_hv8, 10);
                    PEL_LINK(c->put_hevc_epel, 8, 1, 1, epel_hv8, 10);
                    PEL_LINK(c->put_hevc_epel, 9, 1, 1, epel_hv8, 10);

                    PEL_LINK(c->put_hevc_qpel, 1, 0, 0, pel_pixels4 ,10);
                    PEL_LINK(c->put_hevc_qpel, 3, 0, 0, pel_pixels8 ,10);
                    PEL_LINK(c->put_hevc_qpel, 4, 0, 0, pel_pixels4 ,10);
                    PEL_LINK(c->put_hevc_qpel, 5, 0, 0, pel_pixels8 ,10);
                    PEL_LINK(c->put_hevc_qpel, 6, 0, 0, pel_pixels8 ,10);
                    PEL_LINK(c->put_hevc_qpel, 7, 0, 0, pel_pixels8 ,10);
                    PEL_LINK(c->put_hevc_qpel, 8, 0, 0, pel_pixels8 ,10);
                    PEL_LINK(c->put_hevc_qpel, 9, 0, 0, pel_pixels8 ,10);
                    PEL_LINK(c->put_hevc_qpel, 1, 0, 1, qpel_h4,  10);
                    PEL_LINK(c->put_hevc_qpel, 3, 0, 1, qpel_h8,  10);
                    PEL_LINK(c->put_hevc_qpel, 4, 0, 1, qpel_h4,  10);
                    PEL_LINK(c->put_hevc_qpel, 5, 0, 1, qpel_h8,  10);
                    PEL_LINK(c->put_hevc_qpel, 6, 0, 1, qpel_h8,  10);
                    PEL_LINK(c->put_hevc_qpel, 7, 0, 1, qpel_h8,  10);
                    PEL_LINK(c->put_hevc_qpel, 8, 0, 1, qpel_h8,  10);
                    PEL_LINK(c->put_hevc_qpel, 9, 0, 1, qpel_h8,  10);
                    PEL_LINK(c->put_hevc_qpel, 1, 1, 0, qpel_v4,  10);
                    PEL_LINK(c->put_hevc_qpel, 3, 1, 0, qpel_v8,  10);
                    PEL_LINK(c->put_hevc_qpel, 4, 1, 0, qpel_v4,  10);
                    PEL_LINK(c->put_hevc_qpel, 5, 1, 0, qpel_v8,  10);
                    PEL_LINK(c->put_hevc_qpel, 6, 1, 0, qpel_v8,  10);
                    PEL_LINK(c->put_hevc_qpel, 7, 1, 0, qpel_v8,  10);
                    PEL_LINK(c->put_hevc_qpel, 8, 1, 0, qpel_v8,  10);
                    PEL_LINK(c->put_hevc_qpel, 9, 1, 0, qpel_v8,  10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 1, 1, 1, qpel_hv4, 10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 3, 1, 1, qpel_hv8, 10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 4, 1, 1, qpel_hv4, 10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 5, 1, 1, qpel_hv8, 10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 6, 1, 1, qpel_hv8, 10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 7, 1, 1, qpel_hv8, 10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 8, 1, 1, qpel_hv8, 10);
                    PEL_LINK_SSE(c->put_hevc_qpel, 9, 1, 1, qpel_hv8, 10);
